...
<head>
    ...
    <title>@yield('title', 'Kas ' . ($masjidSetting->nama_masjid ?? 'Masjid Jami Baitul Rahman'))</title>
        ...
        * {
        ...
        body {
            ...
            background:
                ...
                linear-gradient(180deg, #f8fcfb 0%, var(--bg-light) 100%);
            color: var(--text-dark);
            display: flex;
            min-height: 100vh;
        }
        ...
        .nav-link.active {
            background: linear-gradient(90deg, rgba(20, 184, 166, 0.16), rgba(20, 184, 166, 0.06));
            color: #ffffff;
            border-left-color: var(--primary-color);
            padding-left: 28px;
            font-weight: 600;
        ...
        .table thead th {
            background: linear-gradient(180deg, #f8fbfa 0%, #f1f5f9 100%);
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div style="display: flex; align-items: center; gap: 12px;">
                <x-masjid-logo :setting="$masjidSetting" :size="40" />

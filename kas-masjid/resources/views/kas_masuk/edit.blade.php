...
<div class="form-container">
    <div class="form-card">
        ...
        <p class="form-subtitle">Perbarui data pemasukan kas masjid</p>
        ...
        <form action="{{ route('kas_masuk.update', $kasMasuk) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    id="tanggal" 
                    name="tanggal" 
                    value="{{ old('tanggal', $kasMasuk->tanggal->format('Y-m-d')) }}" 
                    required
                >
                @error('tanggal')
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    id="jumlah" 
                    name="jumlah" 
                    value="{{ old('jumlah', number_format($kasMasuk->jumlah, 0, '', '')) }}" 
                    required
                >
                @error('jumlah')
                    <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="form-group">
                ...
                <textarea 
                    ...
                    rows="4"
                    required
                >{{ old('keterangan', $kasMasuk->keterangan) }}</textarea>
                @error('keterangan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="info-alert">
                <p>
                    ...
                    <strong>Pastikan data sudah benar</strong> sebelum menyimpan perubahan.
                </p>
            </div>
